                        ...
                        <div class="overview-card">
                            <div class="card card-body mb-4">
                                ...
                                <span class="icon icon-sm rounded-circle bg-primary-light">
                                    ...
                                    <div class="text">
                                        <h6 class="mb-1 card-title">Ví UBGxu</h6>
                                        <span>{{number_format(auth('customer')->user()->ubgxu)}} xu</span>
                                    </div>
                                </article>
                            </div>
                        </div>
                        ...
                        <div class="overview-card">
                            <div class="card card-body mb-4">
                                ...
                                <span class="icon icon-sm rounded-circle bg-primary-light">
                                    ...
                                    <div class="text">
                                        <h6 class="mb-1 card-title">Ví Cộng tác viên</h6>
...
{{--                    </div>--}}
                ...
                <table class="table table-hover table-bordered">
                    <tbody>
                        @if (EcommerceHelper::isAffiliater())
                        <tr>
                            <td>Mã giới thiệu <br/>(Dùng cho việc mở rộng hệ thống cộng tác viên của bạn)</td>
                            <td><b>{{auth('customer')->user()->affiliation_id}}</b></td>
                        </tr>
                        <tr>
                            <td>Link đăng ký nhanh<br/>(Copy và gửi link, hoặc scan mã QR cho cộng tác viên của bạn)</td>
                            <td>
