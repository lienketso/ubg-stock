(function ($) {
    ...
    $(document).on('change', '#address_city', (event) => {
        const $this = $(event.currentTarget);
        $.ajax({
            type: 'GET',
    ...
    $(document).on('change', '#address_state', (event) => {
        const $this = $(event.currentTarget);
        $.ajax({
            type: 'GET',
            url: $this.attr('data-ajax'),
            data: {
                district_id: $('#address_state option:selected', this).attr('data-id')
            },
            success: res => {
