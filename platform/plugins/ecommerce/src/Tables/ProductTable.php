...
//            })
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('products.edit', 'products.destroy', $item,
                    '<a href="'.route('products.clone', $item->id).'" class="btn btn-icon btn-sm btn-warning" data-bs-toggle="tooltip" data-bs-original-title="Nhân bản"><i class="fa fa-clone"></i></a>');
            });
