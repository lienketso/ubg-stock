...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::resource('bill', 'BillController')->parameters(['' => 'bill']);
...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        Route::group(['prefix' => 'checkout/{token}', 'as' => 'public.checkout.'], function () {
            ...
            //vnpay
            Route::post('ajax-vnpay-request', [
                'as' => 'ajax-vnpay-request',
                'uses' => 'PublicCheckoutController@ajaxVnpayRequest'
            ]);

            Route::get('vnpay_php/vnpay_return/{vnp_OrderShippingValue}/{shipping_method_value}/{shipping_method_data}', [
                'as' => 'vnpay-return',
                'uses' => 'PublicCheckoutController@getVnpayReturn'
            ]);
            //endvnpay
