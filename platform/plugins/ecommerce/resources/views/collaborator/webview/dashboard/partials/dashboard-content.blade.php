    ...
    <div class="col-lg-3">
        <div class="card card-body mb-4">
            <article class="icontext">
                ...
                <div class="text">
                    <h6 class="mb-1 card-title">Cộng tác viên dưới</h6>
            ...
            <div class="col-12">
                ...
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-heading">
                        ...
                        Bạn chưa có đơn hàng nào phát sinh! Hãy mở rộng hệ thống cộng tác viên để gia tăng doanh số nhé!
                    </h4>
                    <hr>
                    <p>Link mời cộng tác viên vào nhóm: {{EcommerceHelper::generateAffiliateLink()}}</p>
                </div>
            </div>
        @else
            <div class="col-md-8">
