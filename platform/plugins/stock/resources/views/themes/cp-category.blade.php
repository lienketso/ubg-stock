...
<main class="main" id="main">
        ...
        <div class="container">
            <div class="section-about-inner" style="background-image: url({{asset('vendor/core/plugins/stock/images/map.png')}})">
                <div class="section-about-logo d-flex flex-column align-items-center">
                    <img src="{{ asset('vendor/core/plugins/stock/images/logoubg.png') }}" alt="{{ theme_option('site_title') }}" class="img-fluid mx-auto mb-4">
    ...
    <div class="section-why">
        <div class="container">
            <h2 class="section-why-title text-center">Làm sao để thực hiện đầu tư <br/> tại UBG ?</h2>
                ...
                <div class="section-why-block">
                    <div class="section-why-block-item">
                        ...
                        <div class="section-why-block-item-content">
                            <h4>Đăng ký</h4>
                            <p>Đăng ký một tài khoản duy nhất trong hệ thống UBG</p>
                        </div>
                    </div>
                    <div class="section-why-block-item">
                        <span>2</span>
    ...
    <div class="section-stock-category" id="section-stock-category">
        <div class="container">
            <h2 class="section-stock-category-title">Các danh mục đầu tư <br/>tại UBG</h2>
    ...
    <div class="section-chart">
        <div class="container">
            <h2 class="section-why-title text-center">Cổ phần UBG</h2>
            <div class="row">
                <div class="col-12 col-md-5 section-chart-logo">
                    ...
                    <h4>Biểu đồ tăng trưởng của cổ phẩn UBG, khoản đầu tư an toàn, sinh lời cho các nhà đầu tư</h4>
                </div>
